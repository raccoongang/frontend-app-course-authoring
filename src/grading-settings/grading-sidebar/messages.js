...
const messages = defineMessages({
  gradingSidebarTitle: {
    id: 'course-authoring.grading.sidebar.about.title',
    defaultMessage: 'What can I do on this page?',
  },
  gradingSidebarAbout1: {
    id: 'course-authoring.grading.sidebar.about.text-1',
  ...
  gradingSidebarAbout2: {
    id: 'course-authoring.grading.sidebar.about.text-2',
  ...
  gradingSidebarAbout3: {
    id: 'course-authoring.grading.sidebar.about.text-3',
