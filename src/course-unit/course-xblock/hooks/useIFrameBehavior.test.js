...
jest.mock('./useEventListener', () => jest.fn());
  ...
  describe('behavior', () => {
    ...
    describe('event listener', () => {
      ...
      describe('resize message', () => {
        const heightFromMessageMock = 63;
        const resizeMessage = (height = heightFromMessageMock) => ({
          data: { type: MESSAGE_TYPES.resize, payload: { height } },
        });
        const testSetIFrameHeight = (height = heightFromMessageMock) => {
      ...
      describe('video fullscreen message', () => {
        ...
        const fullScreenMessage = (open) => ({
          data: { type: MESSAGE_TYPES.videoFullScreen, payload: { open } },
        });
        beforeEach(() => {
