...
const getHandlerUrl = async (blockId) => {
  console.log('============== blockId ================', blockId);
  return getXBlockHandlerUrl(blockId, XBLOCK_VIEW_SYSTEM.Studio, 'handler_name');
};
...
const CourseUnit = ({ courseId }) => {
  ...
  return (
    <>
      <LibraryBlock getHandlerUrl={() => {}} view={view} />
