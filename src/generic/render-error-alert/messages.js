...
const messages = defineMessages({
  alertRenderErrorMessage: {
    id: 'course-authoring.course-unit.general.alert.render-error.message',
    defaultMessage: 'Error: {message}',
  },
  alertRenderErrorTitle: {
    id: 'course-authoring.course-unit.general.alert.render-error.title',
    defaultMessage: 'We\'re having trouble rendering your component',
  },
  alertRenderErrorDescription: {
    id: 'course-authoring.course-unit.general.alert.render-error.description',
